...
| [.claude/](.claude/) | Hooks (8), skills (11), role descriptors (7) |
...
| [templates/](templates/) | DESIGN, ADR, POSTMORTEM, RUNBOOK, PATCH-RECORD, RELEASE-NOTES (and 3 more per DASHBOARD §2 — STATUS, TODO, HANDOVER) |
